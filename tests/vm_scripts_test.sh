...
grep -q 'TIGONKV_E2E_TIMEOUT_SEC="$round_timeout"' "$root/scripts/e2e/run_vm_e2e.sh"
grep -q 'TIGONKV_E2E_TIMEOUT_SEC="$round_timeout"' "$root/scripts/e2e/run_vm_trace.sh"
