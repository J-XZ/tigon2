...
tigonkv_e2e_multivm_preflight() {
  ...
  # Multi-VM e2e_08/09 require fixed_value_size=1000.  Do not inherit a leftover
  # YCSB 32/32 TIGONKV_EXPERIMENT_CONFIG_JSONC from a prior shell/experiment.
  export TIGONKV_EXPERIMENT_CONFIG_JSONC="${TIGONKV_E2E_EXPERIMENT_CONFIG_JSONC:-$root/experiment_config.jsonc}"
