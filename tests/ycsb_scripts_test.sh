...
rg -Fq 'TIGONKV_WORKFLOW_CLEANUP_STATUS=0' "$e2e_workflow"
rg -Fq -- '--tool=latencycheck --fair-sched=yes' "$e2e_workflow"
...
rg -Fq 'clean = (cleanup_ok and args.workflow_status == 0' \
  "$root/scripts/e2e/summarize_latencycheck_e2e08.py"
